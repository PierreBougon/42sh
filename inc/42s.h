...
** Last update Thu May 26 19:26:58 2016 marel_m
*/
...
int			redirection_right(t_sh *, t_node *, t_node *);
int			redirection_left(t_sh *, t_node *, t_node *);
int			double_redirection_right(t_sh *, t_node *, t_node *);
